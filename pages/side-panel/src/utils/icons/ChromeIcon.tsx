...
function ChromeIcon({ width = '28', height = '28' }: ChromeIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={`0 0 48 48`}>
      <defs>
        <linearGradient id="asf" x1="3.217" x2="44.781" y1="15" y2="15" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#d93025"></stop>
          <stop offset="1" stopColor="#ea4335"></stop>
        </linearGradient>
        <linearGradient id="bsf" x1="20.722" x2="41.504" y1="47.679" y2="11.684" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#fcc934"></stop>
          <stop offset="1" stopColor="#fbbc04"></stop>
        </linearGradient>
        <linearGradient id="csf" x1="26.598" x2="5.816" y1="46.502" y2="10.506" gradientUnits="userSpaceOnUse">
